...
test("public stories and admin preview render Markdown without executable HTML or URL schemes", () => {
  ...
  assert.equal(journeyMarkdownUrl("https://cdn.example.com/photo.jpg", "src"), "https://cdn.example.com/photo.jpg");
});

test("Markdown preserves custom photo hosts and supports GFM tables and lists", () => {
  const html = render('![山](https://legacy.example.com/2026/photo.jpg)\n\n| 地点 | 天气 |\n| --- | --- |\n| 湖畔 | 晴 |\n\n- [x] 已到达\n- [ ] 下一站');
  assert.match(html, /https:\/\/legacy\.example\.com\/2026\/photo.jpg/);
